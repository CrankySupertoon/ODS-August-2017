# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.battle.Fanfare
...
def doFanfare(delay, toon, panel):
    ...
    play = Parallel(SoundInterval(crabHorn, startTime=1.5, duration=4.0), Sequence(Wait(0.25), longshake([trumpet1, trumpet2], 3, 0.2), Wait(0.5), longshake([trumpet1, trumpet2], 3, 0.2), Wait(0.5), longshake([trumpet1, trumpet2], 9, 0.1), longshake([trumpet1, trumpet2], 3, 0.2)))
    ...
    seq1 = Parallel(Sequence(Wait(delay + 4.1), SoundInterval(drumroll), Wait(0.25), SoundInterval(fanfare)), Sequence(Wait(delay), trumpetsAppear, Wait(3), ballAppear, Wait(0.5), ballShake1, Wait(0.1), ballShake2, Wait(0.2), Wait(0.1), Parallel(openBall, partInterval), Func(fanfareNode.remove)))
