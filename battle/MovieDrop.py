# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.battle.MovieDrop
from panda3d.core import BoundingVolume, Camera, OmniBoundingVolume, Point3, Vec3
...
def __createSuitTrack(drop, delay, level, alreadyDodged, alreadyTeased, target, npcs):
    ...
    if hp > 0:
        suitTrack = Sequence()
        showDamage = Func(suit.showHpText, -hp, openEnded=0, attackTrack=DROP_TRACK, attackLevel=level)
