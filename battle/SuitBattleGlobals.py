# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.battle.SuitBattleGlobals
...
SuitAttributes = {'f': {'name': TTLocalizer.SuitFlunky,
 ...
 'rb': {'name': TTLocalizer.SuitRobberBaron,
        ...
        'attacks': (('PowerTrip',
                     (11, 14, 16, 18, 21),
                     (60, 65, 70, 75, 80),
                     (33, 33, 33, 33, 33)), ('CigarSmoke',
                     (10, 12, 15, 18, 20),
                     (55, 65, 75, 85, 95),
                     (33, 33, 33, 33, 33)), ('TeeOff',
                     (10, 12, 14, 16, 18),
                     (60, 65, 75, 85, 90),
                     (33, 33, 33, 33, 33)))},
 ...
 'bw': {'name': TTLocalizer.SuitBigWig,
        ...
        'attacks': (('PowerTrip',
                     (10, 11, 13, 15, 16),
                     (75, 80, 85, 90, 95),
                     (33, 33, 33, 33, 33)), ('ThrowBook',
                     (14, 16, 18, 20, 22),
                     (70, 75, 85, 90, 95),
                     (33, 33, 33, 33, 33)), ('FingerWag',
                     (13, 15, 17, 19, 21),
                     (80, 85, 85, 85, 90),
                     (33, 33, 33, 33, 33)))},
 'sk': {'name': TTLocalizer.SuitScriptKiddie,
        'singularname': TTLocalizer.SuitScriptKiddieS,
        'pluralname': TTLocalizer.SuitScriptKiddieP,
        'level': 0,
        'hp': (6, 12, 20, 30, 42),
        'def': (2, 5, 10, 12, 15),
        'freq': (50, 30, 10, 5, 5),
        ...
        'attacks': (('PoundKey',
                    ...
                    ('DoubleTalk',
                     ...
                     (50, 60, 70, 80, 90),
                     (20, 20, 20, 20, 20)))},
 'cm': {'name': TTLocalizer.SuitCodeMonkey,
        'singularname': TTLocalizer.SuitCodeMonkeyS,
        'pluralname': TTLocalizer.SuitCodeMonkeyP,
        'level': 1,
        'hp': (12, 20, 30, 42, 56),
        'def': (5, 10, 15, 20, 25),
        'freq': (50, 30, 10, 5, 5),
        ...
        'attacks': (('FingerWag',
                    ...
                    ('Disassemble',
                     ...
                     (75, 75, 75, 75, 75),
                     (30, 30, 30, 30, 30)))},
 'vp': {'name': TTLocalizer.SuitVoodooProgrammer,
        'singularname': TTLocalizer.SuitVoodooProgrammerS,
        'pluralname': TTLocalizer.SuitVoodooProgrammerP,
        'level': 2,
        'hp': (20, 30, 42, 56, 72),
        'def': (10, 15, 20, 25, 30),
        'freq': (50, 30, 10, 5, 5),
        ...
        'attacks': (('Jargon',
                    ...
                    ('VoodooMagic',
                     ...
                     (75, 75, 75, 75, 75),
                     (25, 25, 25, 25, 25)))},
 'db': {'name': TTLocalizer.SuitShotgunDebugger,
        'singularname': TTLocalizer.SuitShotgunDebuggerS,
        'pluralname': TTLocalizer.SuitShotgunDebuggerP,
        'level': 3,
        'hp': (30, 42, 56, 72, 90),
        'def': (15, 20, 25, 30, 35),
        'freq': (50, 30, 10, 5, 5),
        ...
        'attacks': (('GlowerPower',
                    ...
                    ('BrainStorm',
                     ...
                     (50, 60, 70, 80, 90),
                     (20, 20, 20, 20, 20)))},
 'kc': {'name': TTLocalizer.SuitKeyboardCowboy,
        'singularname': TTLocalizer.SuitKeyboardCowboyS,
        'pluralname': TTLocalizer.SuitKeyboardCowboyP,
        'level': 4,
        'hp': (42, 56, 72, 90, 110),
        'def': (20, 25, 30, 35, 40),
        'freq': (50, 30, 10, 5, 5),
        ...
        'attacks': (('HotAir',
                    ...
                    ('Bash',
                     ...
                     (50, 50, 50, 50, 50),
                     (30, 30, 30, 30, 30)))},
 'ss': {'name': TTLocalizer.SuitSoftwareSimian,
        'singularname': TTLocalizer.SuitSoftwareSimianS,
        'pluralname': TTLocalizer.SuitSoftwareSimianP,
        'level': 5,
        'hp': (56, 72, 90, 110, 132),
        'def': (25, 30, 35, 40, 45),
        'freq': (50, 30, 10, 5, 5),
        ...
        'attacks': (('GlowerPower',
                    ...
                    ('ElectrostaticEnergy',
                     ...
                     (60, 60, 60, 60, 60),
                     (30, 30, 30, 30, 30)))},
 'iw': {'name': TTLocalizer.SuitInstallerWizard,
        'singularname': TTLocalizer.SuitInstallerWizardS,
        'pluralname': TTLocalizer.SuitInstallerWizardP,
        'level': 6,
        'hp': (72, 90, 110, 132, 156),
        'def': (30, 35, 40, 45, 50),
        'freq': (50, 30, 10, 5, 5),
        ...
        'attacks': (('VoodooMagic',
                    ...
                    ('DiskScratch',
                     ...
                     (65, 75, 80, 85, 95),
                     (20, 20, 20, 20, 20)))},
 'ru': {'name': TTLocalizer.SuitRootUser,
        'singularname': TTLocalizer.SuitRootUserS,
        'pluralname': TTLocalizer.SuitRootUserP,
        'level': 7,
        'hp': (90, 110, 132, 156, 200),
        'def': (35, 40, 45, 50, 55),
        'freq': (50, 30, 10, 5, 5),
...
SuitAttacks = {'Audit': ('phone', ATK_TGT_SINGLE),
 ...
 'FountainPen': ('fountain-pen', ATK_TGT_SINGLE),
 ...
 'ToonsMiss': ('effort', ATK_TGT_GROUP),
 'CogsHit': ('effort', ATK_TGT_GROUP),
 'CogUp': ('effort', ATK_TGT_GROUP),
 'SoundImmunity': ('effort', ATK_TGT_GROUP),
 'PowerUp': ('effort', ATK_TGT_GROUP),
 'PowerDown': ('effort', ATK_TGT_GROUP),
 'KeyLog': ('magic1', ATK_TGT_SINGLE),
 'Deprecate': ('magic1', ATK_TGT_SINGLE),
 ...
 'DiskScratch': ('hold-pencil', ATK_TGT_GROUP),
 'Reprogram': ('neutral', ATK_TGT_SINGLE)}
...
TOONS_MISS = SuitAttacks.keys().index('ToonsMiss')
COGS_HIT = SuitAttacks.keys().index('CogsHit')
COG_UP = SuitAttacks.keys().index('CogUp')
SOUND_IMMUNITY = SuitAttacks.keys().index('SoundImmunity')
POWER_UP = SuitAttacks.keys().index('PowerUp')
POWER_DOWN = SuitAttacks.keys().index('PowerDown')
KEY_LOG = SuitAttacks.keys().index('KeyLog')
DEPRECATE = SuitAttacks.keys().index('Deprecate')
...
def getAttackTauntIndexFromAttackIndex(attackIndex):
    attackName = SuitAttacks.keys()[attackIndex]
