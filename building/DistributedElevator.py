# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.building.DistributedElevator
from panda3d.core import CollideMask, CollisionNode, CollisionSphere, Lens, NodePath, Point3, TextNode, headsUp
...
class DistributedElevator(DistributedObject.DistributedObject):
    ...
    def fillSlot(self, index, avId, wantBoardingShow = 0):
        ...
        if avId == 0:
            ...
            if avId == base.localAvatar.getDoId():
                ...
                cameraTrack.append(Func(self.toonBoarded, base.localAvatar))
    ...
    def emptySlot5(self, avId, timestamp, time):
        self.emptySlot(5, avId, timestamp, time)
