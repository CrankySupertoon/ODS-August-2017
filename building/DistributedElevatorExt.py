# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.building.DistributedElevatorExt
...
class DistributedElevatorExt(DistributedElevator.DistributedElevator):
    ...
    def setupNametag(self):
        if self.nametag == None:
            ...
            name += TTLocalizer.CogsIncExt.get(chr(self.bldg.track), TTLocalizer.CogsIncExtDefault)
    ...
    def setFloor(self, floorNumber):
        ...
        if hasattr(self, 'bldg'):
            if hasattr(self.bldg, 'floorIndicator'):
