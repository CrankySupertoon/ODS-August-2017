# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.building.DistributedToonHallInterior
...
class DistributedToonHallInterior(DistributedObject, RandomBuilding):
    ...
    def setup(self):
        ...
        self.interior = loader.loadModel('phase_3.5/models/modules/tt_m_ara_int_toonhall')
