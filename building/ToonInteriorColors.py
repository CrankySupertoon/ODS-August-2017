# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.building.ToonInteriorColors
...
colors = {DonaldsDock: {'TI_wainscotting': wainscottingBase,
 ...
 DonaldsDreamland: {'TI_wainscotting': wainscottingBase,
                    ...
                    'TI_door': doorBase,
                    'TI_floor': floorBase},
 CogtownCentral: {'TI_wainscotting': wainscottingBase,
                  'TI_wallpaper': wallpaperBase,
                  'TI_wallpaper_border': wallpaperBorderBase,
                  'TI_door': doorBase + [Vec4(0.8, 0.5, 0.3, 1.0)],
                  'TI_floor': floorBase},
 ForestsEnd: baseScheme,
 MyEstate: baseScheme}