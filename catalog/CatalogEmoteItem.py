# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.catalog.CatalogEmoteItem
...
class CatalogEmoteItem(CatalogItem.CatalogItem):
    ...
    def makeNewItem(self, emote, isSpecial = False):
        self.emoteIndex = TTEmote.Emotes.index(emote)
    ...
    def getPicture(self, avatar):
        ...
        if self.emoteIndex in TTEmote.HeadEmotes:
    ...
    def cleanupPicture(self):
        ...
        self.pictureToon.emoteTrack.finish()
        self.pictureToon.emoteTrack = None
