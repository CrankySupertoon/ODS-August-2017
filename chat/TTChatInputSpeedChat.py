# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.chat.TTChatInputSpeedChat
...
scStructure = [[OTPLocalizer.SCMenuHello,
 ...
 [OTPLocalizer.SCMenuPlaces,
  [OTPLocalizer.SCMenuPlacesControlPanel, 1099],
...
class TTChatInputSpeedChat(DirectObject.DirectObject):
    ...
    def enterActive(self):
        ...
        def handleCancel(self = self):
            if self.chatMgr.fsm.getCurrentState().getName() != 'otherDialog':
