# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.cogdominium.CogdoFlyingObjects
from panda3d.physics import BaseParticleEmitter, BaseParticleRenderer, LinearVectorForce, SparkleParticleRenderer
from panda3d.core import Camera, CollideMask, Fog, Lens, Texture, TextureStage, Vec3, Vec4
import random
