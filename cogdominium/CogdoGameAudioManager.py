# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.cogdominium.CogdoGameAudioManager
...
class CogdoGameAudioManager:
    ...
    def __init__(self, musicFiles, sfxFiles, listener, cutoff = 75):
        ...
        for name, filePath in musicFiles.items():
            self._music[name] = loader.loadMusic(filePath)
