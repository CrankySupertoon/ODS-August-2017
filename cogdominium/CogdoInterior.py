# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.cogdominium.CogdoInterior
...
class CogdoInterior(Place.Place):
    ...
    def enterBattle(self, event):
        self.townBattle.enter(event, self.fsm.getStateNamed('battle'), bldg=1)
