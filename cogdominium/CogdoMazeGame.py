# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.cogdominium.CogdoMazeGame
from panda3d.core import AudioManager, AudioSound, Camera, Lens, NodePath, Point3
...
class CogdoMazeGame(DirectObject):
    ...
    def __updateTask(self, task):
        ...
        for player in self.players:
            if not player.toon or player.toon.isEmpty():
                continue
