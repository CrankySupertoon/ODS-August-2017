# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.cogdominium.CogdoMazeGameMovies
from panda3d.core import GeomNode, NodePath, Plane, PlaneNode, Point3, lookAt
...
from toontown.toon import Toon, ToonHead, ToonDNA, NPCToons
...
class CogdoMazeGameIntro(CogdoGameMovie):
    ...
    def load(self):
        ...
        self.toonDNA.newToonFromProperties(*NPCToons.getNPCDNA(7027))
