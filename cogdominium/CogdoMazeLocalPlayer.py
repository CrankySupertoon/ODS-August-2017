# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.cogdominium.CogdoMazeLocalPlayer
from panda3d.core import Camera, CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionNode, CollisionSphere, NodePath, Point3
...
class CogdoMazeLocalPlayer(CogdoMazePlayer):
    ...
    def __init__(self, id, toon, game, guiMgr):
        ...
        self.hints = {'find': False,
         ...
         'boss': False,
         'minion': False}
        self.accept(base.getKey('jump'), self.controlKeyPressed)
