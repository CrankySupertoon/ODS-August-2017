# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.cogdominium.CogdoUtil
from panda3d.core import ColorBlendAttrib, TextNode, getModelPath
...
def isTrackAllowed(track):
    return track in getAllowedTracks()
