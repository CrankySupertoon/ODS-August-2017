# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.coghq.CashbotHQExterior
...
class CashbotHQExterior(CogHQExterior.CogHQExterior):
    ...
    def __init__(self, loader, parentFSM, doneEvent):
        ...
        for state in ('walk', 'stopped', 'stickerBook', 'squished'):
            self.fsm.getStateNamed(state).addTransition('elevator')
