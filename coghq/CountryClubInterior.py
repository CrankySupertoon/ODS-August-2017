# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.coghq.CountryClubInterior
...
class CountryClubInterior(BattlePlace.BattlePlace):
    ...
    def load(self):
        ...
        self.music = loader.loadMusic(musicName)
    ...
    def enterTownBattle(self, event):
        self.loader.townBattle.enter(event, self.fsm.getStateNamed('battle'), bldg=1)
