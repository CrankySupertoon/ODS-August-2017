# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.fishing.DistributedFishingPond
        ...
        if self.localToonSpot != None:
            for target in self.targets.values():
                ...
                if dist < target.getRadius():
                    ...
                    messenger.send('updateFishingTarget')
                    self.acceptOnce('hitFishingTarget', self.d_hitTarget, [self.currentTarget])
                elif self.currentTarget == target:
                    self.currentTarget = None
                    messenger.send('updateFishingTarget')
                    self.ignore('hitFishingTarget')
