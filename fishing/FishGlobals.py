# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.fishing.FishGlobals
...
Rod2Durability = {0: 100,
 1: 250,
 2: 500,
 3: 750,
 4: 1000}
Rod2RepairJellybean = {0: 0.1,
 1: 0.125,
 2: 0.15,
 3: 0.175,
 4: 0.2}
Rod2JellybeanDict = {0: 10,
 ...
 3: 75,
 4: 150}
Rod2RequiredFish = {0: 0,
 1: 10,
 2: 20,
 3: 30,
 4: 35}
Tank2RequiredFish = {20: 0,
 40: 10,
 60: 20,
 80: 30,
 100: 35}
Lure2RequiredFish = {0: 0,
 1: 10,
 2: 15,
 3: 20,
 4: 25,
...
def getRandomFishVitals(zoneId, rodId, rNumGen = None, av = None):
    if not rNumGen:
        rNumGen = random
    fishList = []
    if av:
        bait = av.getCastBait()
        if bait in getGenera() and random.randint(0, 200) == 0:
            speciesNum = len(getSpecies(bait))
            for species in xrange(speciesNum):
                if not av.fishCollection.hasFish(bait, species):
                    fishList.append((bait, species))

            if not fishList:
                fishList.append((bait, random.randint(0, speciesNum - 1)))
    if not fishList:
