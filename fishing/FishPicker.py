# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.fishing.FishPicker
...
class FishPicker(DirectScrolledList):
    ...
    def __init__(self, parent = aspect2d, **kw):
        ...
        self.fishPanel = FishPanel.FishPanel(parent=self, doneEvent='hideFishPanel')
