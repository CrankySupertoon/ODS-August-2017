# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.fishing.FishSellGUI
...
class FishSellGUI(DirectFrame):
    ...
    def __init__(self, callback):
        ...
        self.cancelButton = DirectButton(parent=self, relief=None, image=cancelImageList, pos=(0.4, 0, -0.58), text=TTLocalizer.FishGuiCancel, text_scale=TTLocalizer.FSGUIcancelButton, text_pos=(0, -0.1), command=callback, extraArgs=[0])
        self.dumpButton = DirectButton(parent=self, relief=None, image=cancelImageList, image_color=(1, 0, 0, 1), pos=(0.1, 0, -0.58), text=TTLocalizer.FishGuiDump, text_scale=TTLocalizer.FSGUIokButton, text_pos=(0, -0.1), command=callback, extraArgs=[2])
        self.okButton = DirectButton(parent=self, relief=None, image=okImageList, pos=(0.7, 0, -0.58), text=TTLocalizer.FishGuiOk, text_scale=TTLocalizer.FSGUIokButton, text_pos=(0, -0.1), command=callback, extraArgs=[1])
