# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.fishing.FishingTargetGlobals
...
__targetInfoDict = {ToontownGlobals.ToontownCentral: (2, -81, 31, -4.8, 14, -1.4),
 ...
 ToontownGlobals.BedtimeBoulevard: (2,
                                    ...
                                    14,
                                    -2.483),
 ToontownGlobals.MyEstate: (5, 30, -126, -0.3, 16, -0.83),
 ToontownGlobals.OutdoorZone: (3, -130.8, -15.5, -0.025, 15, -0.5),
 ToontownGlobals.ForestsEnd: (12, -52.4, 255.8, -0.25, 45, -4.2)}
