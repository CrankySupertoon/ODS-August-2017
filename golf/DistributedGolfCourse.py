# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.golf.DistributedGolfCourse
...
class DistributedGolfCourse(DistributedObject.DistributedObject, FSM, DelayDeletable):
    ...
    def announceGenerate(self):
        ...
        self.request('Join')
        self.normalExit = 1
        loader.beginBulkLoad('minigame', TTLocalizer.HeadingToFactory % self.getTitle(), True, TTLocalizer.TIP_GOLF, ToontownGlobals.GolfZone)
        self.load()
    ...
    def load(self):
        self.music = loader.loadMusic('phase_6/audio/bgm/GZ_PlayGolf.ogg')
