# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.hood.FishAnimatedProp
...
class FishAnimatedProp:
    ...
    def __init__(self, node):
        self.fish = Actor.Actor('phase_4/models/props/SZ_fish-mod', {'jump': 'phase_4/models/props/SZ_fish-jump',
         'swim': 'phase_4/models/props/SZ_fish-swim'}, copy=0)
        self.fish.hide()
