# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.ArrowKeys
...
class ArrowKeys(DirectObject):
    ...
    def enable(self):
        self.disable()
        self.JUMP_KEY, self.UP_KEY, self.DOWN_KEY, self.LEFT_KEY, self.RIGHT_KEY = (base.getKey('jump'),
         base.getKey('up'),
         base.getKey('down'),
         base.getKey('left'),
         base.getKey('right'))
