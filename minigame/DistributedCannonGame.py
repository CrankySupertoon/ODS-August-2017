# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.DistributedCannonGame
from panda3d.core import Lens, Point3, Quat, Vec3, lookAt, rad2Deg
...
class DistributedCannonGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.music = loader.loadMusic('phase_4/audio/bgm/MG_cannon_game_tug.ogg')
    ...
    def __enableAimInterface(self):
        self.aimPad.show()
        self.FIRE_KEY, self.UP_KEY, self.DOWN_KEY, self.LEFT_KEY, self.RIGHT_KEY = (base.getKey('fire'),
         base.getKey('up'),
         base.getKey('down'),
         base.getKey('left'),
         base.getKey('right'))
