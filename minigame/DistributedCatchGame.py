# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.DistributedCatchGame
from panda3d.direct import WaitInterval
from panda3d.core import CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionNode, CollisionSphere, NodePath, Point3, Point4, TextNode, Vec3, lookAt
...
class DistributedCatchGame(DistributedMinigame):
    ...
    def defineConstants(self):
        ...
        fruits = {ToontownGlobals.ToontownCentral: 'apple',
         ...
         ToontownGlobals.ForestsEnd: 'orange'}
    ...
    def getIntroMovie(self):
        ...
        def getIntroToon(npcId, parent, pos):
            toonProperties = NPCToons.getNPCDNA(npcId)
            toon = Toon.Toon()
            dna = ToonDNA.ToonDNA()
        ...
        leftToon = getIntroToon(7025, treeNode, [-2.3, -4, 19.5])
        rightToon = getIntroToon(7026, treeNode, [1.8, -4, 19.5])
        ...
        anvil.setZ(0.42)
        anvil.flattenMedium()
        leftToonIval = getThrowIval(leftToon, leftToon.getRightHand(), fruit, leftToon=1)
        rightToonIval = getThrowIval(rightToon, rightToon.getLeftHand(), anvil, leftToon=0, isAnvil=1)
