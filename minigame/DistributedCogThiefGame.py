# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.DistributedCogThiefGame
from panda3d.direct import WaitInterval
from panda3d.core import CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionNode, CollisionSphere, GeomNode, Lens, NodePath, Plane, Point3, TextNode
...
class DistributedCogThiefGame(DistributedMinigame):
    ...
    def __init__(self, cr):
        ...
        self.stolenBarrels = []
        self.useOrthoWalk = config.GetBool('cog-thief-ortho', 1)
    ...
    def load(self):
        ...
        self.music = loader.loadMusic('phase_4/audio/bgm/MG_CogThief.ogg')
        self.initCogInfo()
        ...
        elif zone in (ToontownGlobals.DonaldsDock, ToontownGlobals.ForestsEnd):
    ...
    def enterPlay(self):
        ...
        self.accept(base.getKey('pickup'), self.controlKeyPressed)
