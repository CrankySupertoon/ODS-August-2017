# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.DistributedIceGame
from panda3d.core import CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionNode, CollisionSphere, NodePath, Point3, Quat, VBase4, Vec3, deg2Rad, headsUp
import math
...
class DistributedIceGame(DistributedMinigame.DistributedMinigame, DistributedIceWorld.DistributedIceWorld):
    ...
    def load(self):
        ...
        self.music = loader.loadMusic('phase_4/audio/bgm/MG_IceGame.ogg')
