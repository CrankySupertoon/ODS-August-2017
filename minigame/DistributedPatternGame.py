# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.DistributedPatternGame
from panda3d.core import Camera, Lens, Point3, VBase4, Vec3, headsUp, lookAt
...
class DistributedPatternGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.toon = NPCToons.createLocalNPC(1)
