# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.DistributedTargetGame
from panda3d.core import BitMask32, CollideMask, CollisionHandler, CollisionHandlerPusher, CollisionNode, CollisionSphere, CollisionTraverser, CompassEffect, Fog, Geom, GeomNode, GeomTrifans, GeomTristrips, GeomVertexData, GeomVertexFormat, GeomVertexWriter, Lens, NodePath, Point3, TextNode, Texture, TransparencyAttrib, Vec4
...
class DistributedTargetGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.music = loader.loadMusic('phase_4/audio/bgm/MG_Diving.ogg')
        ...
        self.umbrella.reparentTo(localAvatar.getRightHand())
    ...
    def setGameReady(self):
        ...
        for avId in self.remoteAvIdList:
            ...
            if toon:
                ...
                umbrella.reparentTo(toon.getRightHand())
                toon.startSmooth()
