# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.DistributedTugOfWarGame
from panda3d.core import Camera, Lens, RopeNode, Texture, VBase3, headsUp
...
class DistributedTugOfWarGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.music = loader.loadMusic(self.bgm)
    ...
    def initToons(self):
        for avId in self.avIdList:
            ...
            if toon:
                ...
                self.rightHandDict[avId] = toon.getRightHand()
                toon.loop('neutral')
