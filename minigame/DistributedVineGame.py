# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.DistributedVineGame
from panda3d.physics import ActorNode, ForceNode, LinearForce, LinearVectorForce, PhysicalNode, PhysicsObject
from panda3d.core import BitMask32, Camera, CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionNode, CollisionSphere, DisplayRegion, Lens, NodePath, PerspectiveLens, Point2, Point3, Vec3, Vec4
...
class DistributedVineGame(DistributedMinigame):
    ...
    def load(self):
        ...
        self.music = loader.loadMusic('phase_4/audio/bgm/MG_Vine.ogg')
    ...
    def onstage(self):
        ...
        torso = base.localAvatar.getTorsoParts().getPath(0)
