# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.ToonBlitzAssetMgr
...
class ToonBlitzAssetMgr(DirectObject):
    ...
    def load(self):
        ...
        self.treasureModelList = [ cogIcons.find(SuitDNA.suitDeptModelPaths[cog]) for cog in SuitDNA.suitDepts ]
        cogIcons.removeNode()
        ...
        self.gameMusic = loader.loadMusic('phase_4/audio/bgm/MG_TwoDGame.ogg')
