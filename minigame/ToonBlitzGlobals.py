# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.ToonBlitzGlobals
...
GameDuration = {ToontownGlobals.ToontownCentral: 150,
 ...
 ToontownGlobals.ForestsEnd: 120}
...
SectionWeights = {ToontownGlobals.ToontownCentral: ((0, 25),
 ...
 ToontownGlobals.DonaldsDreamland: ((0, 10),
                                    ...
                                    (4, 25),
                                    (5, 25)),
 ToontownGlobals.ForestsEnd: ((0, 10),
                              (1, 10),
                              (2, 15),
                              (3, 15),
                              (4, 25),
...
PercentMaxEnemies = {ToontownGlobals.ToontownCentral: 50,
 ...
 ToontownGlobals.ForestsEnd: 100}
