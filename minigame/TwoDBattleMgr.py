# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.minigame.TwoDBattleMgr
from panda3d.core import CollideMask, CollisionHandler, CollisionHandlerEvent, CollisionNode, CollisionSphere, NodePath, Point3, Point4, VBase3, Vec3, lookAt
...
class TwoDBattleMgr(DirectObject):
    ...
    def setupPistol(self):
        ...
        self.handJointPath = self.toon.getRightHand().attachNewNode('handJoint-path')
        pistolPos = Point3(0.28, 0.1, 0.08)
        pistolHpr = VBase3(85.6, -4.44, 94.43)
        MovieUtil.showProp(self.pistol, self.handJointPath, pistolPos, pistolHpr)
