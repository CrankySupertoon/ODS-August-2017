# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.CalendarGuiDay
from panda3d.core import Plane, PlaneNode, TextNode
...
class CalendarGuiDay(DirectFrame):
    ...
    def createGuiObjects(self):
        ...
        self.numberWidget = DirectLabel(parent=self.numberLocator, relief=None, text=str(self.myDate.day), text_scale=0.04, text_align=TextNode.ACenter, text_font=ToontownGlobals.getInterfaceFont(), text_fg=(110 / 255.0,
         126 / 255.0,
         255 / 255.0,
         1))
        self.listXorigin = 0
