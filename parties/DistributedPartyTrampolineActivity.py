# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.DistributedPartyTrampolineActivity
from panda3d.core import Camera, CollideMask, CollisionNode, CollisionSphere, CollisionTube, NodePath, Point3, TextNode, Texture, VBase3, VBase4, lookAt
import math
import time
import random
...
class DistributedPartyTrampolineActivity(DistributedPartyActivity):
    ...
    def beginRound(self):
        ...
        self.accept(base.getKey('jump'), self.onJump)
