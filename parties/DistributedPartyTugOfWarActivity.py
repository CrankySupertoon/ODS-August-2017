# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.DistributedPartyTugOfWarActivity
from panda3d.core import CollideMask, CollisionNode, CollisionTube, NodePath, Point3, RopeNode, Texture, VBase3, lookAt
import math
...
class DistributedPartyTugOfWarActivity(DistributedPartyTeamActivity):
    ...
    def setToonsPlaying(self, leftTeamToonIds, rightTeamToonIds):
        ...
        for toonId in self.getToonIdsAsList():
            toon = self.getAvatar(toonId)
            if toon:
                self.toonIdsToRightHands[toonId] = toon.getRightHand()
