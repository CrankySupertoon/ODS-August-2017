# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.KeyCodes
...
class KeyCodes(DirectObject):
    ...
    def __init__(self, patterns = None, timeout = KEYCODE_TIMEOUT_SECONDS):
        self._keyMap = {base.getKey('up'): 'u',
         base.getKey('down'): 'd',
         base.getKey('left'): 'l',
         base.getKey('right'): 'r'}
