# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.Party
from panda3d.core import Fog, lookAt
...
class Party(Place.Place):
    ...
    def enter(self, requestStatus):
        ...
        self.loader.enterAnimatedProps(self.loader.geom)
    ...
    def exit(self):
        ...
        self.loader.exitAnimatedProps(self.loader.geom)
