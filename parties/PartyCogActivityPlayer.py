# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.PartyCogActivityPlayer
from panda3d.core import Camera, NodePath, Point3, VBase3, lookAt
import math
