# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.PartyEditor
...
class PartyEditor(DirectObject, FSM):
    ...
    def initTrashCan(self):
        self.trashCanButton = DirectButton(parent=self.parent, relief=None, pos=Point3(*PartyGlobals.TrashCanPosition), scale=PartyGlobals.TrashCanScale, geom=Preloaded['trashcan'], command=self.trashCanClicked)
