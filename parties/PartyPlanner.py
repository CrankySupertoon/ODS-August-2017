# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.PartyPlanner
from panda3d.core import NodePath, Point3, TextNode, VBase4
import calendar
...
class PartyPlanner(DirectFrame, FSM):
    ...
    def __createNametag(self, parent):
        if self.nametagGroup == None:
            ...
            self.nametagGroup.setColorCode(NametagGroup.CCNonPlayer)
    ...
    def _createPartyEditorPage(self):
        ...
        self.totalMoney = base.localAvatar.getBankMoney()
        self.beanBank = DirectLabel(parent=page, relief=None, text=str(self.totalMoney), text_align=TextNode.ARight, text_scale=0.075, text_fg=(0.95, 0.95, 0, 1), text_shadow=(0, 0, 0, 1), text_pos=(0.495, -0.53), text_font=ToontownGlobals.getSignFont(), textMayChange=True, image=Preloaded['beanBank'], image_scale=(0.65, 0.65, 0.65), scale=0.9, pos=(-0.75, 0.0, 0.6))
