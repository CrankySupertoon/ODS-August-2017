# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.parties.ToontownTimeManager
...
class ToontownTimeManager(DistributedObject.DistributedObject):
    ...
    def __init__(self, serverTimeAtLogin = 0.0, clientTimeAtLogin = 0.0, realTimeAtLogin = 0.0):
