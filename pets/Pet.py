# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.pets.Pet
from panda3d.core import CollideMask, GeomNode, NodePath, PartBundle, Point3, Texture
...
class Pet(Avatar.Avatar):
    ...
    def getTeleportInTrack(self):
        if not self.teleportHole:
            ...
            if settings['smoothAnimations']:
                self.teleportHole.setBlend(frameBlend=True)
