# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.pets.PetTricks
...
AptitudeIncrementDidTrick = 0.0041
...
TrickHeals = {Tricks.JUMP: (5, 10),
 Tricks.BEG: (7, 15),
 Tricks.PLAYDEAD: (9, 20),
 Tricks.ROLLOVER: (11, 25),
 Tricks.BACKFLIP: (13, 30),
 Tricks.DANCE: (15, 35),
 Tricks.SPEAK: (17, 40),
 Tricks.BALK: (0, 0)}
