# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.racing.KartDNA
...
InvalidEntry = -1
KartInfo = PythonUtil.Enum('name, model, cost, viewDist, decalId, sparkEndPoints')
...
def checkKartFieldValidity(field):
    return field >= KartDNA.bodyType and field <= KartDNA.decalType
