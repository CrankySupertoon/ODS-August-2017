# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.racing.KartShopGui
...
class KartShopGuiMgr(object, DirectObject.DirectObject):
    ...
    class MainMenuDlg(DirectFrame):
        ...
        def updateButtons(self):
            if not base.localAvatar.hasKart() or base.localAvatar.kartDNA[KartDNA.bodyType] in NoAccessories:
    ...
    class BuyKartDlg(DirectFrame):
        ...
        def __init__(self, doneEvent):
            ...
            if base.localAvatar.hasKart():
                k = base.localAvatar.getKartDNAField(KartDNA.bodyType)
    ...
    class BuyAccessoryDlg(DirectFrame):
        ...
        def __init__(self, doneEvent):
            ...
            self.ownedAccList = base.localAvatar.getKartAccessories()
        ...
        def showAccessory(self):
            ...
            if len(base.localAvatar.getKartAccessories()) >= KartShopGlobals.MAX_KART_ACC:
                self.buyAccessoryButton['state'] = DGG.DISABLED
        ...
        def __init__(self, doneEvent, accID):
            ...
            if accType in [KartDNA.ebType,
             ...
             KartDNA.bwwType]:
                ...
                kartDecal = getDecalId(base.localAvatar.getKartDNAField(KartDNA.bodyType))
                texNodePath = getTexCardNode(accID)
    ...
    def __handleConfirmBuyAccessoryDlg(self, exitType, args = []):
        ...
        if exitType == CBA_OPTIONS.Cancel:
            ...
            accList = base.localAvatar.getKartAccessories()
            accList.append(self.accID)
            base.localAvatar.setKartAccessories(accList)
            self.accID = -1
            self.__doDialog(MENUS.BuyAccessory)
