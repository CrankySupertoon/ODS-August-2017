# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.racing.RaceGUI
...
class RaceGUI:
    ...
    def enableSpeedometer(self):
        if self.race and self.race.localKart:
    ...
    def racerEntered(self, avId):
        ...
        if not toon or not kart:
            ...
            headframe = RaceHeadFrame(av=toon.style, color=bodyColor)
