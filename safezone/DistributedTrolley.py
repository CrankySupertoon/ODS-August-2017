# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.safezone.DistributedTrolley
from panda3d.core import BitMask32, CollideMask, Fog, Point3, TextNode, Vec3, headsUp
...
class DistributedTrolley(DistributedObject.DistributedObject):
    ...
    def generate(self):
        ...
        self.trolleyStation = self.loader.geom.find('**/prop_trolley_station')
