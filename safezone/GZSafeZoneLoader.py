# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.safezone.GZSafeZoneLoader
...
class GZSafeZoneLoader(SafeZoneLoader):
    ...
    def __init__(self, hood, parentFSM, doneEvent):
        ...
        self.dnaFile = 'phase_6/dna/golf_zone_sz.bdna'
        del self.fsm
    ...
    def enterPlayground(self, requestStatus):
        ...
        top = self.geom.find('**/linktunnel_10000_DNARoot')
