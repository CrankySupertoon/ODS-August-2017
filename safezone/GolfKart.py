# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.safezone.GolfKart
...
class GolfKart(StateData.StateData):
    ...
    def __init__(self, safeZone, parentFSM, doneEvent, golfCourse):
        ...
        self.fsm = ClassicFSM.ClassicFSM('GolfKart', [State.State('start', self.enterStart, self.exitStart, ['requestBoard', 'trolleyHFA']),
