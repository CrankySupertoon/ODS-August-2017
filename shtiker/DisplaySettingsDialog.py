# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.shtiker.DisplaySettingsDialog
from panda3d.core import TextNode, VBase4, WindowProperties
...
class DisplaySettingsDialog(DirectFrame, StateData.StateData):
    ...
    def load(self):
        if self.isLoaded:
            ...
            self.screenSizeLeftArrow = DirectButton(parent=self, relief=None, image=Preloaded['blueArrow'], scale=(-1.0, 1.0, 1.0), pos=(0.04, 0, -0.085), command=self.__doScreenSizeLeft)
            self.screenSizeRightArrow = DirectButton(parent=self, relief=None, image=Preloaded['blueArrow'], pos=(0.54, 0, -0.085), command=self.__doScreenSizeRight)
            ...
            self.apply = DirectButton(parent=self, relief=None, image=Preloaded['yellowButton'], image_scale=(0.6, 1, 1), text=TTLocalizer.DisplaySettingsApply, text_scale=0.06, text_pos=(0, -0.02), pos=(0.52, 0, -0.53), command=self.__apply)
            self.cancel = DirectButton(parent=self, relief=None, text=TTLocalizer.DisplaySettingsCancel, image=Preloaded['yellowButton'], image_scale=(0.6, 1, 1), text_scale=TTLocalizer.DSDcancel, text_pos=TTLocalizer.DSDcancelPos, pos=(0.2, 0, -0.53), command=self.__cancel)
            self.hide()
            return
