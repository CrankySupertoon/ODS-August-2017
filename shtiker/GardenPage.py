# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.shtiker.GardenPage
...
class GardenPage(ShtikerPage.ShtikerPage):
    ...
    def load(self):
        ...
        self.useSpecialButton = DirectButton(parent=self, relief=None, image=Preloaded['okButton'], pos=(0.45, 0, -0.5), text=TTLocalizer.UseSpecial, text_scale=0.06, text_pos=(0, -0.1), command=self.__useSpecial)
        return
