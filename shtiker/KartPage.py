# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.shtiker.KartPage
...
class RacingRecordsUI(DirectFrame):
    ...
    def show(self):
        bestTimes = self.avatar.getKartingPersonalBest()
    ...
    class ItemViewer(DirectFrame):
        ...
        def setupViewer(self, category):
            ...
            if category == InvalidEntry:
                ...
                accessDict = getAccessDictByType(self.avatar.getKartAccessories())
