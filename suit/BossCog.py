# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.suit.BossCog
...
class BossCog(Avatar.Avatar):
    ...
    def uniqueName(self, name):
        return 'BossCog-%s-%s' % (id(self), name)
    ...
    def getAnim(self, anim):
        ...
        if anim == None:
            ...
            ival = Sequence()
            if self.dna.dept == 'm':
                ival.append(Func(self.setChatAbsolute, random.choice(TTLocalizer.CFOJumpWarningTaunts), CFSpeech | CFTimeout))
