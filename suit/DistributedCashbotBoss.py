# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.suit.DistributedCashbotBoss
...
from panda3d.core import BitMask32, CollideMask, CollisionNode, CollisionPlane, CollisionPolygon, CollisionSphere, GeomNode, Lens, NodePath, Plane, Point3, Texture, VBase3, Vec3, headsUp, lookAt
...
class DistributedCashbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def announceGenerate(self):
        ...
        self.bossDamage = 0
        self.intermissionMusic = loader.loadMusic('phase_9/audio/bgm/CBHQ_Boss_intermission.ogg')
    ...
    def enterEpilogue(self):
        ...
        self.accept(self.resistanceToon.uniqueName('nextChatPage'), self.__epilogueChatNext)
        self.accept(self.resistanceToon.uniqueName('doneChatPage'), self.__epilogueChatDone)
    ...
    def __epilogueChatDone(self, elapsed):
        ...
        self.ignore(self.resistanceToon.uniqueName('nextChatPage'))
