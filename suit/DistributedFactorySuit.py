# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.suit.DistributedFactorySuit
from panda3d.core import CollideMask, CollisionNode, CollisionSphere, ColorBlendAttrib, GeomNode, NodePath, Point3, VBase3, Vec3
...
class DistributedFactorySuit(DistributedSuitBase.DistributedSuitBase, DelayDeletable):
    ...
    def setVirtual(self, isVirtual = 1):
        ...
        if self.virtual:
            for part in self.getGeomNode().findAllMatches('*'):
