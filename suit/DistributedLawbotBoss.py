# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.suit.DistributedLawbotBoss
from panda3d.core import BitMask32, CollideMask, CollisionNode, CollisionPlane, CollisionPolygon, CollisionTube, GeomNode, Lens, NodePath, Plane, Point3, TextNode, VBase3, VBase4, Vec3, headsUp, lookAt
...
class DistributedLawbotBoss(DistributedBossCog.DistributedBossCog, FSM.FSM):
    ...
    def loadEnvironment(self):
        ...
        self.battleTwoMusic = loader.loadMusic('phase_11/audio/bgm/LB_juryBG.ogg')
    ...
    def setScaleTilt(self, tilt):
        self.beamNodePath.setHpr(0, tilt, 0)
        self.prosecutionPanNodePath.setP(0, -tilt, 0)
    ...
    def enterPrepareBattleTwo(self):
        ...
        battlePos = Point3(ToontownGlobals.LawbotBossBattleTwoPosHpr[0], ToontownGlobals.LawbotBossBattleTwoPosHpr[1], ToontownGlobals.LawbotBossBattleTwoPosHpr[2])
        battleHpr = VBase3(ToontownGlobals.LawbotBossBattleTwoPosHpr[3], ToontownGlobals.LawbotBossBattleTwoPosHpr[4], ToontownGlobals.LawbotBossBattleTwoPosHpr[5])
        self.setPosHpr(battlePos, battleHpr)
        base.camera.reparentTo(self.witnessToon)
        base.camera.setPosHpr(0, 8, 2, 180, 10, 0)
        self.witnessToon.setLocalPageChat(TTLocalizer.WitnessToonPrepareBattleTwo % ToontownGlobals.LawbotBossJurorsForBalancedScale, 0)
        self.acceptOnce(self.witnessToon.uniqueName('doneChatPage'), self.__showCannonsAppearing)
    ...
    def exitPrepareBattleTwo(self):
        ...
        self.ignore(self.witnessToon.uniqueName('doneChatPage'))
        self.__clearOnscreenMessage()
        self.stingMusic.stop()
    ...
    def enterPrepareBattleThree(self):
        ...
        self.acceptOnce(self.witnessToon.uniqueName('doneChatPage'), self.__onToBattleThree)
    ...
    def enterEpilogue(self):
        ...
        seq.start()
        self.storeInterval(seq, intervalName)
        self.accept(self.witnessToon.uniqueName('doneChatPage'), self.__doneEpilogue)
    ...
    def __makeWitnessToon(self):
        ...
        self.witnessToon.reparentTo(self.realWitnessStand.find('**/witnessStandSeatEdge'))
        self.witnessToon.setPosHpr(0, -1.15, -1.5, 180, 0, 0)
        self.witnessToon.animFSM.request('Sit')
        self.witnessToon.addActive()

    def __cleanupWitnessToon(self):
        if not self.witnessToon:
            return
        else:
    ...
    def showImmunityTimer(self):
        self.bonusTimer.setFontColor((0, 0, 1, 1))
    ...
    def enteredBonusState(self):
        ...
        self.bonusTimer.setFontColor((0, 0, 0, 1))
