# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.suit.DistributedSuitPlanner
...
class DistributedSuitPlanner(DistributedObject.DistributedObject, SuitPlannerBase.SuitPlannerBase):
    ...
    def setSuitList(self, suitList):
        self.suitList = suitList

    def setBuildingList(self, buildingList):
        self.buildingList = buildingList

    def getBuildingTrack(self, zoneId):
        for zoneId2, track in self.buildingList:
            if zoneId2 == zoneId:
                return chr(track)
