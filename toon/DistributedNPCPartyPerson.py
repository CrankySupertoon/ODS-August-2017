# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.toon.DistributedNPCPartyPerson
...
class DistributedNPCPartyPerson(DistributedNPCToonBase):
    ...
    def getNpcOrigin(self):
        return '**/party_person_%s;+s' % ('left' if self.posIndex % 2 == 0 else 'right')
