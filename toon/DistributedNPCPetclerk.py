# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.toon.DistributedNPCPetclerk
...
class DistributedNPCPetclerk(DistributedNPCToonBase):
    ...
    def __handleFishSold(self, transactionType):
        self.ignore(self.eventDict['fishSold'])
        self.sendUpdate('fishSold', [transactionType])
