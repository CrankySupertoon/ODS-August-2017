# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.toon.LaffMeter
...
class LaffMeter(DirectFrame):
    ...
    def obscure(self, obscured):
        if self.__obscured and not obscured:
            self.show()
        elif obscured:
            self.hide()
    ...
    def load(self):
        ...
        self.setScale(0.1)
        if hType == 'cow':
            self.container['image_scale'] = 1.1
            self.container['image_pos'] = (0.022, 0, 0.25)
        elif hType == 'deer':
            self.container['image_scale'] = 1.125
            self.container['image_pos'] = (0.022, 0, 0.25)
