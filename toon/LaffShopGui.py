# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.toon.LaffShopGui
...
class LaffShopGui(DirectFrame):
    ...
    def setupButtons(self):
        self.cancelButton = DirectButton(parent=self, relief=None, image=Preloaded['closeButton'], pos=(-0.2, 0, -0.5), text=OTPLocalizer.lCancel, text_scale=0.06, text_pos=(0, -0.1), command=self.__cancel, extraArgs=[LaffRestockGlobals.USER_CANCEL])
        self.okButton = DirectButton(parent=self, relief=None, image=Preloaded['okButton'], pos=(0.2, 0, -0.5), text=OTPLocalizer.lOK, text_scale=0.06, text_pos=(0, -0.1), command=self.__restock)
        self.upArrow = DirectButton(parent=self, relief=None, image=Preloaded['fatYellowArrow'], image_scale=(1, 1, 1), image3_color=Vec4(0.6, 0.6, 0.6, 0.25), pos=(0.2, 0, -0.265))
        self.downArrow = DirectButton(parent=self, relief=None, image=Preloaded['fatYellowArrow'], image_scale=(-1, 1, 1), image3_color=Vec4(0.6, 0.6, 0.6, 0.25), pos=(-0.2, 0, -0.265))
        return
    ...
    def __updateLaffMeter(self, amount):
        ...
        if cost > base.localAvatar.getBankMoney():
