# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.toon.NPCToons
...
SELL_MOVIE_DUMPEDFISH = 16
SELL_MOVIE_REPAIRED = 17
SELL_MOVIE_NEWROD = 18
SELL_MOVIE_NEWTANK = 19
SELL_MOVIE_NEWLURE = 20
SELL_MOVIE_BAIT = 21
PARTY_MOVIE_CLEAR = 0
PARTY_MOVIE_START = 1
...
NPC_IDLE = 11
NPC_SKIP = 12
FISHERMAN_COUNTDOWN_TIME = 60
SKIP_COUNTDOWN_TIME = 100
...
def createNPC(air, npcId, desc, zoneId, posIndex = 0, questCallback = None):
    ...
    import DistributedNPCPainterAI
    import DistributedNPCLaffRestockAI
    import DistributedNPCSkipAI
    import DistributedNPCToonBaseAI
    _, name, dnaType, gender, protected, type = desc
    if type == NPC_REGULAR:
    ...
    elif type == NPC_PAINTER:
        npc = DistributedNPCPainterAI.DistributedNPCPainterAI(air, npcId)
    elif type == NPC_LAFF_RESTOCK:
        npc = DistributedNPCLaffRestockAI.DistributedNPCLaffRestockAI(air, npcId)
    elif type == NPC_IDLE:
        npc = DistributedNPCToonBaseAI.DistributedNPCToonBaseAI(air, npcId)
    elif type == NPC_SKIP:
        npc = DistributedNPCSkipAI.DistributedNPCSkipAI(air, npcId)
    else:
...
def createNpcsInZone(air, zoneId):
    npcs = []
    npcIdList = sorted(zone2NpcDict.get(zoneId, []))
...
def createDataNPC(name, dna, state = 'neutral'):
    import Toon
    npc = Toon.Toon()
    npc.setName(name)
    npc.setPickable(False)
    npc.setPlayerType(NametagGroup.CCNonPlayer)
    if hasattr(dna, 'makeNetString'):
        npc.setDNAString(dna.makeNetString())
    else:
        npc.setDNAString(dna)
    npc.animFSM.request(state)
    return npc


def createRandomNPC(name = None):
    dna = ToonDNA.ToonDNA()
    dna.newToonRandom()
    if not name:
        male = dna.gender == 'm'
        name = NameGen.randomNameMoreinfo(male, not male)[-1]
    return createDataNPC(name, dna)
...
def getRandomNpcId():
    return random.choice(NPCToonDict.keys())
...
NPCToonDict = {1: (-1,
 ...
 13002: (-1,
         ...
         0,
         NPC_REGULAR)}
SpecialNPCAttributes = {1400: {'relativePos': (0, -1, 3.95),
        'originId': '**/*boat',
        'shadowHidden': True,
        'chatter': (TTLocalizer.DonaldChatter, 15, True),
        'reparentOnReload': True},
 2001: {'collRadius': 5},
 2025: {'originId': '**/npc_origin_2',
        'reparentOnReload': True},
 11001: {'pos': ((-27.0, -170.0, -19.6), 215.0)},
 12001: {'pos': ((361.9, -394.4, -23.5), 120.0)},
 13001: {'pos': ((143.7, -381.4, -68.4), 0.0)},
 10001: {'pos': ((135.0, 128.8, 0.025), -212.8)}}
del lnames
zone2NpcDict = {}
...
HQnpcFriends = {2001: (ToontownBattleGlobals.HEAL_TRACK,
 ...
 5124: (ToontownBattleGlobals.NPC_TOONS_HIT,
        ...
        0,
        5),
 3119: (ToontownBattleGlobals.NPC_TOONS_POWER_UP,
        1,
        0,
        3),
 3304: (ToontownBattleGlobals.NPC_TOONS_POWER_UP,
        2,
        0,
        4),
 1222: (ToontownBattleGlobals.NPC_TOONS_POWER_UP,
        3,
        0,
        5),
 4138: (ToontownBattleGlobals.NPC_COGS_POWER_DOWN,
        1,
        0,
        3),
 3106: (ToontownBattleGlobals.NPC_COGS_POWER_DOWN,
        2,
        0,
        4),
 3308: (ToontownBattleGlobals.NPC_COGS_POWER_DOWN,
        3,
        0,
        5),
 ...
 1329: (ToontownBattleGlobals.NPC_RESTOCK_GAGS,
        ...
        0,
        3)}
FOnpcFriends = {100: (ToontownBattleGlobals.HEAL_TRACK,
       3,
       10,
       0),
 101: (ToontownBattleGlobals.HEAL_TRACK,
       3,
       20,
       1),
 102: (ToontownBattleGlobals.HEAL_TRACK,
       3,
       30,
       2),
 103: (ToontownBattleGlobals.DROP_TRACK,
       1,
       20,
       0),
 104: (ToontownBattleGlobals.DROP_TRACK,
       2,
       35,
       1),
 105: (ToontownBattleGlobals.DROP_TRACK,
       3,
       50,
       2),
 106: (ToontownBattleGlobals.SOUND_TRACK,
       1,
       10,
       0),
 107: (ToontownBattleGlobals.SOUND_TRACK,
       3,
       20,
       1),
 108: (ToontownBattleGlobals.SOUND_TRACK,
       4,
       30,
       2),
 109: (ToontownBattleGlobals.LURE_TRACK,
       1,
       0,
       0),
 110: (ToontownBattleGlobals.LURE_TRACK,
       1,
       0,
       1),
 111: (ToontownBattleGlobals.LURE_TRACK,
       3,
       0,
       2)}
...
def testNpcDna():
    for key, value in NPCToonDict.iteritems():
        dnaList = value[2]
        if dnaList == 'r':
            continue
        try:
            ...
            return 'Failed test for %s (%s)' % (value[1], key)
