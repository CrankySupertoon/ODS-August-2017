# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.toonbase.ToontownLoader
...
class ToontownLoader(Loader):
    ...
    def __init__(self, base):
        ...
        self.soundCache = {}
        self.modelCache = {}
        self.loadingScreen = ToontownLoadingScreen.ToontownLoadingScreen(self)
        return
    ...
    def loadDNAFile(self, dnastore, filename, loadVis = True):
        return DNAParser.loadDNAFile(dnastore, filename, loadVis)

    def beginBulkLoad(self, name, label, gui, tipCategory, zoneId):
        if self.inBulkBlock:
            return
