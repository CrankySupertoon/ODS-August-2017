# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.toonbase.ToontownStartRemoteDB
import json, os, sys
...
distribution = 'qa'
accountServerEndpoint = 'http://localhost:8000/api/'
...
req = urllib2.Request(accountServerEndpoint + 'login', data, headers={'Content-Type': 'application/x-www-form-urlencoded'})
