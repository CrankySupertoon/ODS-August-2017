# Fuck you Disyer. Stealing my fucking paypal. GET FUCKED: toontown.town.TownBattleChooseAvatarPanel
...
class TownBattleChooseAvatarPanel(StateData.StateData):
    ...
    def load(self):
        ...
        self.frame.hide()
        self.statusFrame = DirectFrame(parent=self.frame, relief=None, image=Preloaded['toonBattlePanel'], image_color=Vec4(0.5, 0.9, 0.5, 1), pos=(0.611, 0, 0))
